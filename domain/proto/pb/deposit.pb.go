...
type AboveThresholdTable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BalanceHistory []*Balance `protobuf:"bytes,1,rep,name=balance_history,json=balanceHistory,proto3" json:"balance_history,omitempty"`
}

func (x *AboveThresholdTable) Reset() {
	*x = AboveThresholdTable{}
	if protoimpl.UnsafeEnabled {
...
func (x *AboveThresholdTable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AboveThresholdTable) ProtoMessage() {}

func (x *AboveThresholdTable) ProtoReflect() protoreflect.Message {
	mi := &file_deposit_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AboveThresholdTable.ProtoReflect.Descriptor instead.
func (*AboveThresholdTable) Descriptor() ([]byte, []int) {
	return file_deposit_proto_rawDescGZIP(), []int{2}
}

func (x *AboveThresholdTable) GetBalanceHistory() []*Balance {
	if x != nil {
...
var file_deposit_proto_rawDesc = []byte{
	...
	0x41, 0x74, 0x22, 0x4b, 0x0a, 0x13, 0x41, 0x62, 0x6f, 0x76, 0x65, 0x54, 0x68, 0x72, 0x65, 0x73,
	0x68, 0x6f, 0x6c, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x34, 0x0a, 0x0f, 0x62, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x5f, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52,
	0x0e, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x42,
...
var file_deposit_proto_goTypes = []interface{}{
	...
	(*AboveThresholdTable)(nil),   // 2: pb.AboveThresholdTable
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_deposit_proto_depIdxs = []int32{
	3, // 0: pb.Balance.created_at:type_name -> google.protobuf.Timestamp
	1, // 1: pb.AboveThresholdTable.balance_history:type_name -> pb.Balance
...
func file_deposit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_deposit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AboveThresholdTable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
